...
class WrappingPaperTest{
    ...
    @Test
    fun `returns the total wrapping paper needed for all presents advent of code list`() {
...
""".trimIndent().split("\n")
        ...
        val actual = underTest.paperNeeded(allBoxes)

        assertEquals(expected, actual)
    }

    @Test
    fun `34ft of ribbon is needed for a 2x3x4 box`() {

        val underTest = WrappingPaper()
        val expected = 34
        val actual = underTest.ribbonNeeded(listOf("2x3x4"))

        assertEquals(expected, actual)
    }

    @Test
    fun `returns total ribbon needed for advent challenge`() {
...
""".trimIndent().split("\n")
        ...
        val actual = underTest.ribbonNeeded(allBoxes)
